...
## 요약
시스템 자율 사이클 실행을 요청받아 현재 운영 상태 및 다음 작업 우선순위 결정을 위한 메모리 검토를 시작합니다.

## 분배
- **📱 영숙**: 최근 의사결정, 회사 목표, 각 에이전트의 개인 목표(_agents/{id}/goal.md), 그리고 최근 메모리를 즉시 검토하여 현재 가장 가치 있는 단일 작업 1개를 선정하고 그 실행 계획을 준비하라.
