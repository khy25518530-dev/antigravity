...
## 요약
사용자의 자율 사이클 지시에 따라 회사 목표와 에이전트 메모리를 검토하여 가장 가치 있는 단일 작업을 결정하고 실행해야 합니다.

## 분배
- **📱 영숙**: 모든 에이전트의 개인 목표(_agents/{id}/goal.md), 최근 의사결정, 메모리를 검토하여 현재 가장 가치 있는 단일 작업 1개를 결정하고, 이를 실행하기 위한 초기 계획을 수립하라.
