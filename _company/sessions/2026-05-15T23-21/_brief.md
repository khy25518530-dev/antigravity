...
## 요약
24시간 자율 사이클을 시작하고 현재 메모리와 목표를 검토하여 가장 가치 있는 단일 작업과 실행 계획을 수립합니다.

## 분배
- **📱 영숙**: 최근 의사결정, 회사 목표, 에이전트 개인 목표(_agents/{id}/goal.md), 그리고 최근 메모리를 즉시 검토하여 현재 가장 가치 있는 단일 작업 1개를 결정하고 실행 계획을 수립하라.
